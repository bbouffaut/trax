...
flags.DEFINE_string('output_filename', '/tmp/my.subword_text_encoder',
                    'where to store the SubwordTextEncoder')
flags.DEFINE_string('corpus_filepattern', '',
                    'Corpus of one or more text files')
flags.DEFINE_string(
    'vocab_filepattern', '', 'One or more vocabulary files '
    '(one word per line as "word,count")')
flags.DEFINE_integer('min_count', 5, 'Minimum subtoken count in corpus')
flags.DEFINE_integer('corpus_max_lines', 10000,
